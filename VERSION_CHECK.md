# Version Check — 0.2.0.1

Version **0.2.0.1** is the locked active baseline. Historical version numbers in `CHANGELOG.md` are intentionally preserved.

## Verified active references

- `DeskPulse.Shared` AppInfo: `0.2.0.1`
- `DeskPulse.Shared.csproj`: `0.2.0.1`
- `DeskPulse.Service.csproj`: `0.2.0.1`
- `DeskPulse.Tray.csproj`: `0.2.0.1`
- Inno Setup installer and output filename: `0.2.0.1`
- Publish folders: `publish\v0.2.0.1\service` and `publish\v0.2.0.1\tray`
- README, HANDOVER, ROADMAP, GITHUB_RELEASE and current CHANGELOG entry: `0.2.0.1`
...
- [ ] `Publish.ps1` creates both self-contained executables under `publish\v0.2.0.1`.
- [ ] `Build-Installer.ps1` creates `DeskPulse_Setup_0.2.0.1.exe`.
