...
- Temporary logging pause and resume
...
File Activity can also be filtered by the application responsible for an event. This helps suppress repetitive background activity while retaining activity generated by other applications.
