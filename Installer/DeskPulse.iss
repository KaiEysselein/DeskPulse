...
OutputDir=..\publish\v0.2.2.0\installer
...
[Files]
Source: "..\publish\v0.2.2.0\service\*"; DestDir: "{app}\Service"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "..\publish\v0.2.2.0\tray\*"; DestDir: "{app}\Tray"; Flags: ignoreversion recursesubdirs createallsubdirs
